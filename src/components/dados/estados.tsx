...
export function EstadoDeErro({
  ...
  return (
    <div
      role="alert"
      className="rounded-cartao flex flex-col items-start gap-3 border border-red-900 bg-red-950/50 p-4 text-sm text-red-200"
    >
      ...
      {podeRepetir && aoTentarNovamente && (
        <button
          ...
          className="inline-flex items-center gap-1.5 rounded-full border border-red-800 px-3 py-1 text-xs font-semibold hover:bg-red-900 focus:ring-2 focus:ring-red-400 focus:outline-none"
        >
...
export function EstadoVazio({
  ...
  return (
    <div className="border-borda rounded-cartao flex flex-col items-center justify-center gap-2 border border-dashed px-6 py-10 text-center">
